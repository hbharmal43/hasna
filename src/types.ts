export type MessageType = {
  type: 'START_AUTOMATION' | 'STOP_AUTOMATION' | 'GET_STATE' | 'AUTH_STATE_CHANGED' | 'SAVE_USER_DATA' | 'AUTOFILL_CURRENT_PAGE' | 'START_CONTINUOUS_AUTOFILL' | 'STOP_CONTINUOUS_AUTOFILL';
  data?: UserProfile;
  settings?: {
    nextJobDelay: number;
  };
